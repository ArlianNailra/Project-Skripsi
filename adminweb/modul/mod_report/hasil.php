...
<nav class="navbar navbar-inverse" >
	<ul class="nav navbar-nav">
		<li class="<?php if($_GET['sub']=='all'){echo'active';} ?>"><a href="?module=hasil&sub=all">Hasil Kuesioner </a></li>
...
<?php if ($_GET['sub']=='all'){ ?>
	<div class="panel panel-primary">
		<div class="panel-heading">
			<div class="panel-title">Hasil Penilaian Keseluruhan Kuesioner</div>
		</div>
		...
		<div class="panel-body">
			<table id="myHTMLTable" border="0" cellpadding="5" class="table table-striped">
				<tr>
				<th width="1%"><font size=2 face=tahoma>No</font></th> 
				<th width="18%"><font size=2 face=tahoma>Hasil Kuesioner</font></th>
				<th width="18%"><font size=2 face=tahoma>Penjelasan</font></th>
				
				</tr>
			<?php

			$sql = mysqli_query($conn, "SELECT * FROM fix_hasil");
			$no=1;
			while($data = mysqli_fetch_array($sql)){
				?>
				<tr>
								<td><div id="kontentd"><?php echo $no; ?></div></td>
								<td><div id="kontentd"><?php echo $data['hasil1'];?></div></td>
								<td><div id="kontentd"><?php echo $data['hasil2'];?></div></td>
								</tr>

							<?php $no++; }  ?>
			
					 <tr>
						<td><font size=3 face=tahoma></font></td>
