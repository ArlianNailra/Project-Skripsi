...
if ($_SESSION[level] == 'Super'){
	...
	switch($_GET[act]){
		...
		<div class="row">
		    <div class="col-lg-12">
		        <h1 class="page-header">
		            <i class="glyphicon glyphicon-user"></i> Manajemen Admin
		        </h1>
		        <ol class="breadcrumb">
		            <li class="active">
		                 <a href="master.php?module=user">Manajemen Admin</a>
		            </li>
		        </ol>
		    </div>
		</div>
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="panel-title"><span class="glyphicon glyphicon-list"></span> Daftar Admin <i style="margin-left:820px;"><button class="btn btn-success btn-sm " onclick="window.location.href='?module=user&act=tambahuser'"><span class="glyphicon glyphicon-plus"></span> Tambah Admin</button></i></div>
			</div>
			<div class="panel-body">
				<table id="tablekonten" class="table table-striped table-bordered table-responsive" style="">
					...
					<tbody>
						<?php 
						$tampil = mysqli_query($conn, "SELECT * FROM tuser");
						$no=1;
	...
	<div class="row">
	    <div class="col-lg-12">
	        ...
	        <ol class="breadcrumb">
	            <li class="active">
	                 <a href="master.php?module=user">Manajemen Admin</a> / <a href="master.php?module=user&act=tambahuser">Tambah Admin</a>
	            </li>
	        </ol>
	    </div>
	</div>
	<div class="panel panel-primary">
    	<div class="panel-heading">
			<div class="panel-title"><span class="glyphicon glyphicon-list"></span> Tambah Admin <i style="margin-left:830px;"><button class="btn btn-success btn-sm " onclick="window.location.href='?module=user'"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</button></i></div>
		</div>
		<div class="panel-body">
	...
	case "edituser":
		$edit=mysqli_query("SELECT * FROM tuser WHERE userId='$_GET[id]'");
		...
		<div class="row">
		    <div class="col-lg-12">
		        ...
		        <ol class="breadcrumb">
		            <li class="active">
		                 <a href="master.php?module=user">Manajemen Admin</a> / <a href="?module=user&act=edituser&id=<?php echo $r['userId'];?>">Edit Admin</a>
		            </li>
		        </ol>
		    </div>
		</div>
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="panel-title">
					<i class="glyphicon glyphicon-wrench"></i> Edit Admin
				</div>
			</div>
			<div class="panel-body">
