            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="<?php if($_GET['module']=='user'){echo'active';} ?>">
                        <a href="?module=user"><i class="glyphicon glyphicon-user"></i> Manajemen Admin</a>
                    </li>
                    <li class="<?php if($_GET['module']=='group'){echo'active';} ?>">
                        <a href="?module=group"><i class="glyphicon glyphicon-list"></i> Data Pelanggan</a>
                    </li>
                    <li class="<?php if($_GET['module']=='description'){echo'active';} ?>">
                        <a href="?module=description"><i class="glyphicon glyphicon-book"></i> Kriteria CSI</a>
                    </li>
